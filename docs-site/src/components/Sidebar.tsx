  ...
  return (
    <aside className={mobile ? 'w-full' : 'w-72 flex-shrink-0 hidden lg:block'}>
      <div className={mobile ? 'pb-6' : 'sticky top-20 h-[calc(100vh-5rem)] overflow-y-auto pb-10 pr-4'}>
        {/* Search placeholder */}
        <div className="mb-6">
          <button className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-slate-500 dark:text-slate-400 bg-white dark:bg-slate-800/50 rounded-xl border border-indigo-100 dark:border-slate-700 hover:border-indigo-200 shadow-sm shadow-indigo-500/5 dark:shadow-none dark:hover:border-slate-600 transition-colors">
              ...
              <div key={section.title} className="mb-1">
                <button
                  ...
                  className={`w-full flex items-center justify-between px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                    hasActiveItem
                      ? 'text-slate-800 dark:text-white bg-indigo-50/50 dark:bg-slate-800/50'
                      : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-indigo-50/30 dark:hover:bg-slate-800/30'
                  }`}
                >
        ...
        <div className="mt-8 pt-6 border-t border-slate-200 dark:border-slate-800">
          <div className="flex items-center justify-between px-3 py-2 rounded-lg bg-indigo-50/40 dark:bg-slate-800/50">
